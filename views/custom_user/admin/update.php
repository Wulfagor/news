...
$this->title = Yii::t('user', 'Update user: ' . $user->profile->name . ' (id' . $user->id . ')');
            ...
            <div class="panel-body">
                <?= Nav::widget([
                    ...
                    'items' => [
                        ...
                        ['label' => Yii::t('user', 'Profile details'), 'url' => ['/user/admin/update-profile', 'id' => $user->id], 'visible' => $user->id == 1 ? false : true],
